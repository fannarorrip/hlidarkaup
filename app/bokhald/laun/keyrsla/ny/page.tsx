...
export default async function NyKeyrslaPage() {
  ...
  return (
    <div>
      ...
      <NyKeyrsla employees={employees.map((e) => ({ id: e.id, name: e.name, employment_type: e.employment_type, monthly_salary: e.monthly_salary, hourly_rate: e.hourly_rate, wage_category: e.wage_category }))} />
    </div>
  );
}
