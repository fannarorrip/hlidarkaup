...
const RULES: { prefix: string; roles: string[] }[] = [
  ...
  // Tímar starfsmanna: stjórnandi + bókari (EKKI lagerstjóri — ákvörðun 2026-07-28).
  { prefix: "/bokhald/timar", roles: ["stjornandi", "bokari"] },
  ...
  { prefix: "/api/birgdaskyrsla", roles: ["stjornandi", "bokari", "lagerstjori"] },
  { prefix: "/api/afstemming", roles: ["stjornandi", "bokari"] },
  { prefix: "/api/kassauppgjor", roles: ["stjornandi", "bokari", "lagerstjori"] },
  ...
  { prefix: "/api/customers", roles: ["stjornandi", "bokari", "afgreidsla", "lagerstjori"] },
  ...
  { prefix: "/starf", roles: ["stjornandi", "bokari", "afgreidsla", "eldhus", "lagerstjori"] },
];
