...
export interface StaffSession { email: string; sub?: string; role: string; exp: number; mfa?: boolean; kiosk?: boolean; }

export async function createStaffSession(
  payload: { email: string; sub?: string; role: string; mfa?: boolean; kiosk?: boolean }, ttlSeconds = 60 * 60 * 12,
): Promise<string> {
