...
const CartContext = createContext<{
  items: CartItem[]; add: (product: Product) => void;
  remove: (productId: string) => void; setQty: (productId: string, quantity: number) => void;
  clear: () => void; total: number; count: number;
} | null>(null);

const STORAGE_KEY = "hlidarkaup_cart";
